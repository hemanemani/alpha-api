...
@section('content')
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-between">
            <div>
                <h3 class="my-4">Add International Inquiry</h3>  
            </div>
            <div>
                <a href="{{ route('international.inquiries.downloadTemplate') }}" class="btn btn-success">
                    Download Template
                </a>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bulkInternationalUploadModal">
                    Bulk Upload Inquiries
                </button>
            </div>
        </div>

        <form action="{{ route('international_inquiries.store') }}" method="POST">
            @csrf
    ...
    <!-- Modal -->
    <div class="modal fade" id="bulkInternationalUploadModal" tabindex="-1" aria-labelledby="bulkInternationalUploadModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bulkInternationalUploadModalLabel">Bulk Upload Inquiries</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('international.inquiries.bulkUpload') }}" method="POST" enctype="multipart/form-data">
                    @csrf
